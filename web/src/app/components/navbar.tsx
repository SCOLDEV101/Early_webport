    ...
    return (
        ...
        >
            <Menu setActive={setActive}>
                ...
                <div className="flex flex-row flex-nowrap justify-center items-center gap-16">
                    ...
                    <MenuItem setActive={setActive} active={active} item="About" >
                        ...
                        <div className="flex flex-col space-y-1">
                            {/*  Popup menu ของ About แค่ปุ่มเดียว ในที่นี้มี 3 ปุ่ม */}
                ...
                {/* Enquiry button */}
                <Link href="#Enquiry" type="button" className=" bg-[#ECF0FF] rounded-[10px] w-[150px] px-3 py-1 transition-shadow hover:shadow-[0px_4px_13.1px_0px_rgba(255,255,255,0.4),0px_10px_20px_-15px_rgba(236,240,255,1)]">
                    <h5 className="bg-gradient-to-r from-[#6580E1] to-[#5844D7] bg-clip-text text-transparent text-center font-bold">
                        Enquiry
                    </h5>
                </Link>
            </Menu>
